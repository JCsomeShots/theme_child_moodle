...
if ($ADMIN->fulltree) {                                                                                                             
    ...
    $setting = new admin_setting_configtextarea('theme_child/scsspre',                                                              
        get_string('rawscsspre', 'theme_child'), get_string('rawscsspre_desc', 'theme_child'), '', PARAM_RAW);                      
    $setting->set_updatedcallback('theme_reset_all_caches');                                                                        
    $page->add($setting);                                                                                                           
                                                                                                                                    
    // Raw SCSS to include after the content.                                                                                       
    $setting = new admin_setting_configtextarea('theme_child/scss', get_string('rawscss', 'theme_child'),                           
        get_string('rawscss_desc', 'theme_child'), '', PARAM_RAW);                                                                  
    $setting->set_updatedcallback('theme_reset_all_caches');                                                                        
    $page->add($setting);                                                                                                           
